...
import com.islam.slider.Transformers.*;
import com.islam.slider.Tricks.*;
...
import static com.islam.slider.SliderTypes.BaseSliderView.ScaleType.CenterCrop;
import static com.islam.slider.SliderTypes.BaseSliderView.ScaleType.CenterInside;
import static com.islam.slider.SliderTypes.BaseSliderView.ScaleType.Fit;
import static com.islam.slider.SliderTypes.BaseSliderView.ScaleType.FitCenterCrop;
...
public class SliderLayout extends RelativeLayout{
    ...
    private BaseSliderView.ScaleType scaleType;
    ...
    public SliderLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        int scale = attributes.getInt(R.styleable.SliderLayout_scaleType, 0);
        switch (scale){
            case 0:scaleType= CenterCrop;break;
            case 1:scaleType= CenterInside;break;
            case 2:scaleType= Fit;break;
            case 3:scaleType= FitCenterCrop;break;
        }
    ...
    public <T extends BaseSliderView> void addSlider(T imageContent){
        imageContent.setScaleType(scaleType);
