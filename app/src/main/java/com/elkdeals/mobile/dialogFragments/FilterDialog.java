...
import com.elkdeals.mobile.adapters.FilterProductsAdapter;
...
import com.elkdeals.mobile.api.models.filter_model.post_filters.FiltersPrice;
...
public abstract class FilterDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        filter_min_price = findViewById(R.id.filter_min_price);
        filter_max_price = findViewById(R.id.filter_max_price);
        filter_cancel_btn = findViewById(R.id.filter_cancel_btn);
        filter_clear_btn = findViewById(R.id.filter_clear_btn);
        filter_apply_btn = findViewById(R.id.filter_apply_btn);
        filter_price_slider = findViewById(R.id.filter_price_slider);
        filter_attributes_recycler = findViewById(R.id.filters_recycler);
        filterDialogAttributes = findViewById(R.id.filter_dialog_attributes);
