...
public class AuctionsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (TextUtils.isEmpty(fragmentToStart))
            fragmentToStart = AuctionsCategories.TAG;
    ...
    public void initViews() {
        ...
        addPage(getFragment(fragmentToStart),new AuctionsCategories());
    }
