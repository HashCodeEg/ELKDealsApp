package com.elkdeals.mobile.api.models.product_model;
...
public class ProductDetails implements Parcelable {
    ...
    public String names = "";
    public String getCategoriesNameWithPatent(String old) {
        CategoryDetails categoryDetails = CategoryData.read(""+categoriesId);
        if (categoryDetails == null)
            return old;
        else names = "";
        while (categoryDetails!=null&&
                !TextUtils.isEmpty(categoryDetails.getId().replace("0",""))){
            if (!TextUtils.isEmpty(names))
                names = names.concat(" > ");
            names = names.concat(categoryDetails.getName());
            categoryDetails = CategoryData.read(categoryDetails.getParentId());
        }
        return names;
    }
    ...
    public ProductDetails setCategoriesId(String categoriesId) {
        try {
    ...
    public void writeToParcel(Parcel parcel_out, int flags) {
        ...
        parcel_out.writeInt(defaultStock);
        ...
        parcel_out.writeString(contactCompany);
        parcel_out.writeString(contactPerson);
        parcel_out.writeString(enquiryStatus);
    ...
    protected ProductDetails(Parcel parcel_in) {
        ...
        this.defaultStock = parcel_in.readInt();
        ...
        this.enquiryStatus = parcel_in.readString();
        this.contactCompany = parcel_in.readString();
        this.contactPerson = parcel_in.readString();
