...
public class DB_Handler extends SQLiteOpenHelper {
    ...
    public DB_Handler() {
        super(App.getInstance(), DB_NAME, null, DB_VERSION);
    }
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(User_Auctions_DB.createTableCart());
    }
    ...
    public void onUpgrade(SQLiteDatabase db, int i, int i1) {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + User_Auctions_DB.TABLE_Auctions);
