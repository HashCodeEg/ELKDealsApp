...
public class RoundImageView extends AppCompatImageView {
     ...
     * 描边的颜色、宽度
     */
    private int mBorderColor, mCircleBackgroundColor;
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        type = a.getInt(R.styleable.custom_type, TYPE_ROUND);
        mBorderColor = a.getColor(R.styleable.custom_border_color, Color.WHITE);
        mCircleBackgroundColor = a.getColor(R.styleable.custom_circle_background_color, Color.TRANSPARENT);
        mBorderWidth = a.getDimension(R.styleable.custom_border_width, 0);
        mCornerRadius = a.getDimension(R.styleable.custom_corner_radius_custom, dp2px(0));
        mLeftTopCornerRadius = a.getDimension(R.styleable.custom_leftTop_corner_radius, 0);
        mLeftBottomCornerRadius = a.getDimension(R.styleable.custom_leftBottom_corner_radius, 0);
        mRightTopCornerRadius = a.getDimension(R.styleable.custom_rightTop_corner_radius, 0);
        mRightBottomCornerRadius = a.getDimension(R.styleable.custom_rightBottom_corner_radius, 0);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (type == TYPE_ROUND) {
            ...
            canvas.drawPath(mRoundPath, mCircleBackgroundPaint);
            ...
            canvas.drawCircle(mRadius + mBorderWidth / 2, mRadius + mBorderWidth / 2, mRadius, mCircleBackgroundPaint);
            ...
            canvas.drawOval(mRoundRect, mCircleBackgroundPaint);
