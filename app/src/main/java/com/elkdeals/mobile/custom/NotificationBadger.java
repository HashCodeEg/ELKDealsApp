...
public class NotificationBadger extends Drawable {
    ...
    public NotificationBadger(Context context) {
        ...
        badgePaint1.setColor(ContextCompat.getColor(context.getApplicationContext(), R.color.colorAccentAuctions));
        badgePaint1.setAntiAlias(true);
        badgePaint1.setStyle(Paint.Style.FILL);

        badgePaint2 = new Paint();
        badgePaint2.setColor(ContextCompat.getColor(context.getApplicationContext(), R.color.colorAccentAuctions));
...
//        if(count1.length() <= 2) {
//            // Draw Badge circle.
//            canvas.drawCircle(centerX, centerY, (int)(radius+12), badgePaint2);
//            //canvas.drawCircle(centerX, centerY, (int)(radius+5.5), badgePaint1);
//        }
//        else {
//            canvas.drawCircle(centerX, centerY, (int)(radius+15), badgePaint2);
...
//        }
        ...
        float textWidth = rect1.right - rect1.left;
        float mRadius = ((Math.max(textWidth, textHeight) / 2));
        float textY = centerY + (textHeight / 2f);
        canvas.drawCircle(centerX, centerY, (int) (mRadius + 12), badgePaint2);
