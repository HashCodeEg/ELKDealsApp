package com.islam.circleprogressview;
...
public class CircleProgressView extends View {
    ...
    float mSpinningBarLengthOrig = 80;
    ...
    private boolean mCustomShowUnit = true;
    //clipping
