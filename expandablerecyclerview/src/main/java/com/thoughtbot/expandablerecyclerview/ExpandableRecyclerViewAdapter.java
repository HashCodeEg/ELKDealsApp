...
public abstract class ExpandableRecyclerViewAdapter<GVH extends GroupViewHolder, CVH extends ChildViewHolder>
    ...
    private final boolean allowMultipleExpand;
    ...
    private boolean expandaple = true;

    public ExpandableRecyclerViewAdapter(List<? extends ExpandableGroup> groups, boolean allowMultipleExpand) {
        this.expandableList = new ExpandableList(groups);
        this.groups=groups;
        this.expandCollapseController = new ExpandCollapseController(expandableList, this, allowMultipleExpand);
        ...
        switch (listPos.type) {
            case ExpandableListPosition.GROUP:
                ...
                if (isGroupExpanded(group)) {
                    ...
                    ;//expandableList.expandedGroupIndexes[expandableList.getUnflattenedPosition(expandableList.getFlattenedGroupIndex(group)).groupPos] = false;
                break;
            case ExpandableListPosition.CHILD:
    ...
    public boolean onGroupClick(int flatPos) {
        ...
        else if (expandCollapseController.isGroupExpanded(flatPos))
    ...
    public void setExpandaple(boolean expandaple) {
        this.expandaple = expandaple;
        this.expandableList = new ExpandableList(groups);
        this.expandCollapseController = new ExpandCollapseController(expandableList, this, allowMultipleExpand);
    }
}
